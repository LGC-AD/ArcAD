...
from dataset import MVTecDataset, AnomalyDataset, get_data_transforms
...
def train(item_list):
    ...
    for i, item in enumerate(item_list):
        ...
        train_path = os.path.join(args.data_path, item, 'train', 'label')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/hanningning/AD/mvtec_CD')
