...
def train(item_list):
    ...
    for i, item in enumerate(item_list):
        ...
        train_data_label = RealIADDataset(root=root_path, category=item, transform=data_transform, gt_transform=gt_transform, phase='labeled')
        test_data = RealIADDataset(root=root_path, category=item, transform=data_transform, gt_transform=gt_transform, phase="test")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/hanningning/AD/Real-IAD_CD')
    ...
    parser.add_argument('--proto_path', type=str, default='../SemiDinomaly/Real-IAD_init_files500/prototypes_init.pth',
                        )
