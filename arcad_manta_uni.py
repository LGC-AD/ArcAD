...
from dataset import MANTADataset, get_data_transforms
...
def train(item_list):
    ...
    for i, item in enumerate(item_list):
        ...
        train_data_label = MANTADataset(root=root_path, category=item, transform=data_transform, gt_transform=gt_transform, phase='labeled')
        test_data = MANTADataset(root=root_path, category=item, transform=data_transform, gt_transform=gt_transform, phase="test")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='../MANTA_CD')
    ...
    parser.add_argument('--proto_path', type=str, default='./MANTA_init_files800/prototypes_init.pth',
                        )
